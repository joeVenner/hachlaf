...
export default function Hero({ hero }) {
  ...
  return (
    <section
      id="top"
      className="hero-section relative z-[1] hero-viewport w-full flex items-center overflow-hidden"
    >
      <motion.div
        variants={containerVariants}
        initial="hidden"
        animate="visible"
        className="hero-content site-container w-full h-full flex flex-col justify-center py-24"
      >
        <div className="max-w-[650px]">
          ...
          <motion.div variants={itemVariants} className="mb-8 md:mb-10">
            ...
            <span className="hero-eyebrow-sub flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] md:text-xs font-display font-medium uppercase tracking-[0.18em] text-white/50">
          ...
          <motion.p
            ...
            className="hero-subtitle text-lg md:text-xl xl:text-[1.375rem] leading-[1.5] text-white/80 max-w-[560px] mb-10 md:mb-12"
          >
            {hero.subtitle}
          </motion.p>
          ...
          <motion.div
            variants={itemVariants}
            className="hero-actions flex flex-col sm:flex-row items-start gap-4 mb-12 md:mb-14"
          >
            <a href="#projects" className="btn-gold group w-full sm:w-auto">
              {hero.ctaPrimary}
              <ArrowRight className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" />
            </a>
            <a href="#contact" className="hero-secondary-cta btn-glass w-full sm:w-auto">
              {hero.ctaSecondary}
            </a>
          </motion.div>
      ...
      <motion.a
        ...
        className="hero-scroll-indicator absolute bottom-8 md:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-white/50 hover:text-white/80 transition-colors"
